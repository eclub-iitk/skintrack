...
for j in range(4):
    for i in range(30):
        ...
        sheet1.write(i+1+30*j,0,max_p1)
        sheet1.write(i+1+30*j,1,max_p2)
        sheet1.write(i+1+30*j,2,max_m1)
        sheet1.write(i+1+30*j,3,max_m2)
        ...
        sheet1.write(i+1+30*j,4,min_p1)
        sheet1.write(i+1+30*j,5,min_p2)
        sheet1.write(i+1+30*j,6,min_m1)
        sheet1.write(i+1+30*j,7,min_m2)
...
#slope sign change
        ...
        sheet1.write(i+1+30*j,8,nslopep1)
        sheet1.write(i+1+30*j,9,nslopep2)
        sheet1.write(i+1+30*j,10,nslopem1)
        sheet1.write(i+1+30*j,11,nslopem2)
...
#median absolute deviation
        ...
        f83=mad(col3)
        f84=mad(col4)
        sheet1.write(i+1+30*j,12,f81)
        sheet1.write(i+1+30*j,13,f82)
        sheet1.write(i+1+30*j,14,f83)
        sheet1.write(i+1+30*j,15,f84)
...
#iqr
        ...
        f93=iqr(col3)
        f94=iqr(col4)
        sheet1.write(i+1+30*j,16,f91)
        sheet1.write(i+1+30*j,17,f92)
        sheet1.write(i+1+30*j,18,f93)
        sheet1.write(i+1+30*j,19,f94)
...
#skew
        ...
        f103=skew(col3)
        f104=skew(col4)
        sheet1.write(i+1+30*j,20,f101)
        sheet1.write(i+1+30*j,21,f102)
        sheet1.write(i+1+30*j,22,f103)
        sheet1.write(i+1+30*j,23,f104)
...
#kurtosis
        ...
        f113=kurtosis(col3)
        f114=kurtosis(col4)
        sheet1.write(i+1+30*j,24,f111)
        sheet1.write(i+1+30*j,25,f112)
        sheet1.write(i+1+30*j,26,f113)
        sheet1.write(i+1+30*j,27,f114)
...
#skew_freq_domain
        ...
        f123=abs(skew(col3))
        f124=abs(skew(col4))
        sheet1.write(i+1+30*j,28,f121)
        sheet1.write(i+1+30*j,29,f122)
        sheet1.write(i+1+30*j,30,f123)
        sheet1.write(i+1+30*j,31,f124)
...
#kurtosis_freq_domain
        ...
        sheet1.write(i+1+30*j,32,f131)
        sheet1.write(i+1+30*j,33,f132)
        sheet1.write(i+1+30*j,34,f133)
        sheet1.write(i+1+30*j,35,f134)
        ...
        sheet1.write(i+1+30*j,36,med_p1)
        sheet1.write(i+1+30*j,37,med_p2)
        sheet1.write(i+1+30*j,38,med_m1)
        sheet1.write(i+1+30*j,39,med_m2)
    ...
    #standard deviation
        ...
        sheet1.write(i+1+30*j,40,std_p1)
        sheet1.write(i+1+30*j,41,std_p2)
        sheet1.write(i+1+30*j,42,std_m1)
        sheet1.write(i+1+30*j,43,std_m2)
    ...
    #sum
        ...
        sheet1.write(i+1+30*j,44,sum_p1)
        sheet1.write(i+1+30*j,45,sum_p2)
        sheet1.write(i+1+30*j,46,sum_m1)
        sheet1.write(i+1+30*j,47,sum_m2)
        ...
        sheet1.write(i+1+30*j,48,w)
        sheet1.write(i+1+30*j,49,x)
        sheet1.write(i+1+30*j,50,y)
        sheet1.write(i+1+30*j,51,z)
        ...
        sheet1.write(i+1+30*j,52,w)
        sheet1.write(i+1+30*j,53,x)
        sheet1.write(i+1+30*j,54,y)
        sheet1.write(i+1+30*j,55,z)
        ...
        sheet1.write(i+1+30*j,56,w)
        sheet1.write(i+1+30*j,57,x)
        sheet1.write(i+1+30*j,58,y)
        sheet1.write(i+1+30*j,59,z)
        ...
        sheet1.write(i+1+30*j,60,w)
        sheet1.write(i+1+30*j,61,x)
        sheet1.write(i+1+30*j,62,y)
        sheet1.write(i+1+30*j,63,z)
        ...
        sheet1.write(i+1+30*j,64,w)
        sheet1.write(i+1+30*j,65,x)
        sheet1.write(i+1+30*j,66,y)
        sheet1.write(i+1+30*j,67,z)
        ...
        y=rl_feature(col3)
        z=rl_feature(col4)
        sheet1.write(i+1+30*j,68,w)
        sheet1.write(i+1+30*j,69,x)
        sheet1.write(i+1+30*j,70,y)
        sheet1.write(i+1+30*j,71,z)



        sheet1.write(i+1+30*j,72,j)

book.save("final4.xls")    

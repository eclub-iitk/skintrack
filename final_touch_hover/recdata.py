...
socketno=3333
                                                  ...
                                                  #no of diff inputs
j = 111111 #no of diff value of each inputs
...
t=t2-t1 
print(t)         
book.save('hover%d.xls'%(j))
s.close()

mydata=pd.read_excel('hover%d.xls'%(j))
...
fs = values/t #sampling frequency in rad/s
...
print(1000*diff_p1 ,1000*diff_p2 ,1000*diff_m1, 1000*diff_m2)

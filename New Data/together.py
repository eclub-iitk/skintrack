...
for j in range(3):
    for i in range(4):
        ...
        for h in range(len(col1)):
            sheet1.write(h+(i+j*4)*len(col1),0,col1[h])
            sheet2.write(h+(i+j*4)*len(col2),1,col2[h])
            sheet2.write(h+(i+j*4)*len(col3),2,col3[h])
            sheet2.write(h+(i+j*4)*len(col4),3,col4[h])

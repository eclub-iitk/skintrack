...
for j in range(2):
    for i in range(10):
        mydata=pd.read_excel('%s%d.xls'%(a[j],i+31))
        ...
        sheet1.write(10*j+i,0,mean_p1)
        sheet1.write(10*j+i,1,mean_p2)
        sheet1.write(10*j+i,2,mean_m1)
        sheet1.write(10*j+i,3,mean_m2)
        ...
        sheet1.write(10*j+i,4,max_p1)
        sheet1.write(10*j+i,5,max_p2)
        sheet1.write(10*j+i,6,max_m1)
        sheet1.write(10*j+i,7,max_m2)
        ...
        sheet1.write(10*j+i,8,iqr_p1)
        sheet1.write(10*j+i,9,iqr_p2)
        sheet1.write(10*j+i,10,iqr_m1)
        sheet1.write(10*j+i,11,iqr_m2)
        ...
        sheet1.write(10*j+i,12,min_p1)
        sheet1.write(10*j+i,13,min_p2)
        sheet1.write(10*j+i,14,min_m1)
        sheet1.write(10*j+i,15,min_m2)
        ...
        sheet1.write(10*j+i,0+16,med_p1)
        sheet1.write(10*j+i,1+16,med_p2)
        sheet1.write(10*j+i,2+16,med_m1)
        sheet1.write(10*j+i,3+16,med_m2)
        ...
        sheet1.write(10*j+i,0+20,range_p1)
        sheet1.write(10*j+i,1+20,range_p2)
        sheet1.write(10*j+i,2+20,range_m1)
        sheet1.write(10*j+i,3+20,range_m2)
        ...
        sheet1.write(10*j+i,0+24,std_p1)
        sheet1.write(10*j+i,1+24,std_p2)
        sheet1.write(10*j+i,2+24,std_m1)
        sheet1.write(10*j+i,3+24,std_m2)
        ...
        sheet1.write(10*j+i,0+28,sum_p1)
        sheet1.write(10*j+i,1+28,sum_p2)
        sheet1.write(10*j+i,2+28,sum_m1)
        sheet1.write(10*j+i,3+28,sum_m2)
        ...
        sheet1.write(10*j+i,0+32,rms_p1)
        sheet1.write(10*j+i,1+32,rms_p2)
        sheet1.write(10*j+i,2+32,rms_m1)
        sheet1.write(10*j+i,3+32,rms_m2)
        #IQR
        sheet1.write(10*j+i,36,j)
        ...
        print(ent_p1)
        sheet1.write(10*j+i,0+36,ent_p1)
        sheet1.write(10*j+i,1+36,ent_p2)
        sheet1.write(10*j+i,2+36,ent_m1)
        sheet1.write(10*j+i,3+36,ent_m2)
        """
book.save("total_feature_testing.xls")        
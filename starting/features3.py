...
for i in range(3):
    ...
    #mean
        ...
        sheet1.write(20*i+j+1,0,mean_p1)
        sheet1.write(20*i+j+1,1,mean_p2)
        sheet1.write(20*i+j+1,2,mean_m1)
        sheet1.write(20*i+j+1,3,mean_m2)
        ...
        sheet1.write(20*i+j+1,4,max_p1)
        sheet1.write(20*i+j+1,5,max_p2)
        sheet1.write(20*i+j+1,6,max_m1)
        sheet1.write(20*i+j+1,7,max_m2)
        ...
        sheet1.write(20*i+j+1,8,iqr_p1)
        sheet1.write(20*i+j+1,9,iqr_p2)
        sheet1.write(20*i+j+1,10,iqr_m1)
        sheet1.write(20*i+j+1,11,iqr_m2)
        ...
        sheet1.write(20*i+j+1,12,min_p1)
        sheet1.write(20*i+j+1,13,min_p2)
        sheet1.write(20*i+j+1,14,min_m1)
        sheet1.write(20*i+j+1,15,min_m2)
        ...
        sheet1.write(20*i+j+1,0+16,med_p1)
        sheet1.write(20*i+j+1,1+16,med_p2)
        sheet1.write(20*i+j+1,2+16,med_m1)
        sheet1.write(20*i+j+1,3+16,med_m2)
        ...
        sheet1.write(20*i+j+1,0+20,range_p1)
        sheet1.write(20*i+j+1,1+20,range_p2)
        sheet1.write(20*i+j+1,2+20,range_m1)
        sheet1.write(20*i+j+1,3+20,range_m2)
        ...
        sheet1.write(20*i+j+1,0+24,std_p1)
        sheet1.write(20*i+j+1,1+24,std_p2)
        sheet1.write(20*i+j+1,2+24,std_m1)
        sheet1.write(20*i+j+1,3+24,std_m2)
        ...
        sheet1.write(20*i+j+1,0+28,sum_p1)
        sheet1.write(20*i+j+1,1+28,sum_p2)
        sheet1.write(20*i+j+1,2+28,sum_m1)
        sheet1.write(20*i+j+1,3+28,sum_m2)
        ...
        sheet1.write(20*i+j+1,0+32,rms_p1)
        sheet1.write(20*i+j+1,1+32,rms_p2)
        sheet1.write(20*i+j+1,2+32,rms_m1)
        sheet1.write(20*i+j+1,3+32,rms_m2)
        #IQR
        sheet1.write(20*i+j+1,36,i)
    ...
    """
        ...
        print(ent_p1)
        sheet1.write(20*i+j+1,0+36,ent_p1)
        sheet1.write(20*i+j+1,1+36,ent_p2)
        sheet1.write(20*i+j+1,2+36,ent_m1)
        sheet1.write(20*i+j+1,3+36,ent_m2)
    """
    book.save("1test==.xls")        

...
for j in range(3):
    ...
    #mean
        ...
        sheet1.write(i+25*j,0,mean_p1)
        sheet1.write(i+25*j,1,mean_p2)
        sheet1.write(i+25*j,2,mean_m1)
        sheet1.write(i+25*j,3,mean_m2)
        ...
        sheet1.write(i+25*j,4,max_p1)
        sheet1.write(i+25*j,5,max_p2)
        sheet1.write(i+25*j,6,max_m1)
        sheet1.write(i+25*j,7,max_m2)
        ...
        sheet1.write(i+25*j,8,iqr_p1)
        sheet1.write(i+25*j,9,iqr_p2)
        sheet1.write(i+25*j,10,iqr_m1)
        sheet1.write(i+25*j,11,iqr_m2)
        ...
        sheet1.write(i+25*j,12,min_p1)
        sheet1.write(i+25*j,13,min_p2)
        sheet1.write(i+25*j,14,min_m1)
        sheet1.write(i+25*j,15,min_m2)
        ...
        sheet1.write(i+25*j,0+16,med_p1)
        sheet1.write(i+25*j,1+16,med_p2)
        sheet1.write(i+25*j,2+16,med_m1)
        sheet1.write(i+25*j,3+16,med_m2)
        ...
        sheet1.write(i+25*j,0+20,range_p1)
        sheet1.write(i+25*j,1+20,range_p2)
        sheet1.write(i+25*j,2+20,range_m1)
        sheet1.write(i+25*j,3+20,range_m2)
        ...
        sheet1.write(i+25*j,0+24,std_p1)
        sheet1.write(i+25*j,1+24,std_p2)
        sheet1.write(i+25*j,2+24,std_m1)
        sheet1.write(i+25*j,3+24,std_m2)
        ...
        sheet1.write(i+25*j,0+28,sum_p1)
        sheet1.write(i+25*j,1+28,sum_p2)
        sheet1.write(i+25*j,2+28,sum_m1)
        sheet1.write(i+25*j,3+28,sum_m2)
        ...
        sheet1.write(i+25*j,0+32,rms_p1)
        sheet1.write(i+25*j,1+32,rms_p2)
        sheet1.write(i+25*j,2+32,rms_m1)
        sheet1.write(i+25*j,3+32,rms_m2)
        #IQR
        sheet1.write(i+25*j,36,j)
    ...
    """
        ...
        print(ent_p1)
        sheet1.write(i+25*j,0+36,ent_p1)
        sheet1.write(i+25*j,1+36,ent_p2)
        sheet1.write(i+25*j,2+36,ent_m1)
        sheet1.write(i+25*j,3+36,ent_m2)
    """
    book.save("x025.xls")        
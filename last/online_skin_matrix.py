...
mydata=pd.read_excel('last==.xls')
feat=mydata.iloc[:,0:1]
feat.as_matrix()
...
while(1):
    ...
    col1 = signal.savgol_filter(col1,75,3)
    col2 = signal.savgol_filter(col2,75,3)
    col3 = signal.savgol_filter(col3,75,3)
    col4 = signal.savgol_filter(col4,75,3)

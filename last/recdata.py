...
socketno=3333
                                                  #no of diff inputs
v =2 #no of diff value of each inputs
...
fs = 600/2.58 #sampling frequency in rad/s
...
col1 = signal.savgol_filter(col1,301,3)
col2 = signal.savgol_filter(col2,301,3)
col3 = signal.savgol_filter(col3,301,3)
col4 = signal.savgol_filter(col4,301,3)
